...
flowchart TB
    ...
    subgraph K8s["Kubernetes Cluster"]
        LiteLLM["LiteLLM Proxy port :4000 · NodePort :32000"]
...
### Required if you want to use vLLM horizonital auto-scaling with KEDA
```
helm repo add kedacore https://kedacore.github.io/charts
helm install keda kedacore/keda --namespace keda --create-namespace
```

### Required if you want to use an API Gateway to expose LLM-d
```
# Istio Gateway
microk8s enable dns
...
> **Note:** The unified architecture diagram at the top of this document covers all deployment modes. The sections below describe the specific configuration files for each mode.
